...
(buffer-timer-start)
                                        ...
                                        ; reporting
(global-set-key "\C-cbs" 'buffer-timer-summarize)
(global-set-key "\C-cbr" 'buffer-timer-report)
(global-set-key "\C-cbS" 'buffer-timer-write-results)
(global-set-key "\C-cbc" 'buffer-timer-clear)
(global-set-key "\C-cbm" 'buffer-timer-munge)
(global-set-key "\C-cbM" 'buffer-timer-munge-date-range)

                                        ; modifying data
(global-set-key "\C-cbt" 'buffer-timer-transfer-time)
(global-set-key "\C-cba" 'buffer-timer-adjust-time)
(global-set-key "\C-cbA" 'buffer-timer-adjust-older-time)

                                        ; locking to a subject
(global-set-key "\C-cbi" 'buffer-timer-toggle-idle)
(global-set-key "\C-cbl" 'buffer-timer-lock)
(global-set-key "\C-cbu" 'buffer-timer-unlock)
(global-set-key "\C-cbU" 'buffer-timer-do-idle-calculations)
(global-set-key "\C-cbL" 'buffer-timer-view-log)
